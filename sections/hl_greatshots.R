...
hl_shot1_ui = function(){
  "hl_shot1" = story_section(
    ...
    content = list(
      p(HTML("This shot by Adam Taylor (<a href = 'https://inaturalist.ca/people/marmota_taylor'>@marmota_taylor</a>) of the Vancouver Island Marmot (<i>Marmota vancouverensis</i>) was one of the most popular in Blitz the Gap this summer. This species is endemic to Vancouver Island, British Columbia. It is also <b>Endangered in Canada</b> (<a href ='https://www.canada.ca/en/environment-climate-change/services/species-risk-public-registry.html#summary-details1'>Canadian Species at Risk Act</a>)")),
        img(src = "https://inaturalist-open-data.s3.amazonaws.com/photos/526940551/large.jpg", 
            width = "350px"),
        p(HTML("© Adam Taylor (<a href = 'https://inaturalist.ca/people/marmota_taylor'>@marmota_taylor</a>), some rights reserved (CC-BY-NC) | <a href = 'https://inaturalist.ca/observations/292793285'>View observation</a>"))
  )
  )
}
...
hl_shot2_ui = function(){
  "hl_shot2" = story_section(
    title = "Action shot!",
    content = list(
      p(HTML("A Barred Owl (<i>Strix varia</i>) snacking on a Signal Crayfish (<i>Pacifastacus leniusculus</i>) that it fished out of a creek! This photo is a valuable record of a predator-prey interaction, which play a hugely important role in our ecosystems though they are difficult to document!"),
        img(src = "https://inaturalist-open-data.s3.amazonaws.com/photos/522082463/large.jpg", 
            width = "350px"),
        p(HTML("© Brian Starzomski (<a href = 'https://inaturalist.ca/people/bstarzomski'>@bstarzomski</a>), some rights reserved (CC-BY-NC) | <a href = 'https://inaturalist.ca/observations/290230351'>View observation</a>"))
        )
  ))
}
